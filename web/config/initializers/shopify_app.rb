...
ShopifyApp.configure do |config|
  config.webhooks = [
    { topic: 'shop/update', address: 'api/custom_webhooks/shop_update' },

    { topic: 'app_subscriptions/update', address: 'api/custom_webhooks/app_subscriptions_update' },
    { topic: 'app_subscriptions/approaching_capped_amount', address: 'api/custom_webhooks/app_subscriptions_approaching_capped_amount' },
    # After a store owner uninstalls your app, Shopify invokes the APP_UNINSTALLED webhook
    # to let your app know.
    { topic: 'app/uninstalled', address: 'api/custom_webhooks/app_uninstalled' },
  ]
...
def add_privacy_webhooks
  privacy_webhooks = [
    ...
    { topic: 'shop/redact', address: 'api/custom_webhooks/shop_redact' },
    ...
    { topic: 'customers/redact', address: 'api/custom_webhooks/customers_redact' },
    ...
    { topic: 'customers/data_request', address: 'api/custom_webhooks/customers_data_request' },
  ]
